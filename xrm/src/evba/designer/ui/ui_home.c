...
void home_ui_create(home_ui_t *ui)
{
	...
	lv_obj_set_pos(ui->label_player, 74, 119);
	lv_obj_set_size(ui->label_player, 93, 30);
#endif // LV_USE_LABEL
	...
	lv_obj_set_pos(ui->label_photo, 225, 118);
	lv_obj_set_size(ui->label_photo, 94, 31);
#endif // LV_USE_LABEL
	...
	lv_obj_set_pos(ui->label_music, 371, 119);
	lv_obj_set_size(ui->label_music, 94, 31);
#endif // LV_USE_LABEL
	...
	lv_obj_set_pos(ui->label_file, 75, 262);
	lv_obj_set_size(ui->label_file, 94, 31);
#endif // LV_USE_LABEL
	...
	lv_obj_set_pos(ui->label_phone, 370, 262);
	lv_obj_set_size(ui->label_phone, 94, 31);
#endif // LV_USE_LABEL
	...
	lv_obj_set_pos(ui->cont_tip, 86, 82);
	...
	lv_obj_set_pos(ui->label_tip_title, 5, 5);
