...
void menu_ui_create(menu_ui_t *ui)
{
	...
	lv_obj_set_pos(ui->cont_botton, 0, 327);
	lv_obj_set_size(ui->cont_botton, 480, 32);
	...
	lv_obj_set_pos(ui->label_val, 352, 10);
	...
	ui->bar_vol_blue = lv_bar_create(ui->cont_botton, NULL);
	lv_obj_set_pos(ui->bar_vol_blue, 74, 9);
