...
static lv_style_t style2_file_list;
static lv_style_t style3_file_list;
static lv_style_t style4_file_list;
static lv_style_t style5_file_list;
static lv_style_t style6_file_list;
static lv_style_t style7_file_list;
static lv_style_t style8_file_list;
...
void file_ui_create(file_ui_t *ui)
{
	...
	style0_cont_main.body.padding.top = 0;
	style0_cont_main.body.padding.bottom = 0;
	style0_cont_main.body.padding.left = 0;
	style0_cont_main.body.padding.right = 0;
	style0_cont_main.body.padding.inner = 0;
	...
	style0_file_list.body.shadow.color = lv_color_hex(0x4456c6);
	style0_file_list.body.padding.inner = 0;
	...
	lv_style_copy(&style2_file_list, &lv_style_pretty_color);
	...
	style3_file_list.text.line_space = 0;
	...
	style4_file_list.text.line_space = 0;
	...
	style5_file_list.body.border.color = lv_color_hex(0xffffff);
	style5_file_list.body.border.opa = 255;
	style5_file_list.body.shadow.color = lv_color_hex(0x101d6b);
	style5_file_list.text.line_space = 2;

	lv_style_copy(&style6_file_list, &lv_style_btn_tgl_rel);
	style6_file_list.body.main_color = lv_color_hex(0xffffff);
	style6_file_list.body.grad_color = lv_color_hex(0x4456c6);
	style6_file_list.body.radius = 0;
	style6_file_list.body.border.color = lv_color_hex(0x4456c6);
	style6_file_list.body.border.width = 0;
	style6_file_list.body.border.opa = 255;
	style6_file_list.text.line_space = 2;

	lv_style_copy(&style7_file_list, &lv_style_btn_tgl_pr);
	style7_file_list.body.main_color = lv_color_hex(0x101d6b);
	style7_file_list.body.grad_color = lv_color_hex(0x101d6b);
	style7_file_list.body.radius = 0;
	style7_file_list.body.border.color = lv_color_hex(0xffffff);
	style7_file_list.body.border.opa = 255;
	style7_file_list.body.shadow.color = lv_color_hex(0x101d6b);
	style7_file_list.text.line_space = 2;

	lv_style_copy(&style8_file_list, &lv_style_btn_ina);

	ui->file_list = lv_list_create(ui->cont_main, NULL);
	lv_obj_set_pos(ui->file_list, 0, 54);
	lv_obj_set_size(ui->file_list, 480, 303);
	lv_list_set_single_mode(ui->file_list, true);
	...
	lv_list_set_style(ui->file_list, LV_LIST_STYLE_SB, &style2_file_list);
	...
	lv_list_set_style(ui->file_list, LV_LIST_STYLE_BTN_TGL_REL, &style6_file_list);
	lv_list_set_style(ui->file_list, LV_LIST_STYLE_BTN_TGL_PR, &style7_file_list);
	lv_list_set_style(ui->file_list, LV_LIST_STYLE_BTN_INA, &style8_file_list);
#endif // LV_USE_LIST
